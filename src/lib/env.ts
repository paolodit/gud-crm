...
const environmentSchema = z.object({
  ...
  GUD_PUBLIC_DEMO: z.enum(["true", "false"]).default("false"),
...
export const env = {
  ...
  publicDemo: values.GUD_PUBLIC_DEMO === "true" || new URL(values.NEXT_PUBLIC_APP_URL).hostname === "guddemo.refreshcreative.com",
