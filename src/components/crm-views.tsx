  ...
  return (
    <WorkspaceFrame title="Settings" subtitle="Workspace shape, data readiness and operational guardrails">
      ...
      <section className="settings-grid">
        ...
        <article className="surface settings-card"><div className="settings-icon"><KeyRound /></div><div><h2>Login readiness</h2><p>Password and account recovery controls</p></div><div className="status-list"><StatusRow label="Email/password sign-in" value={runtime.passwordAuthActive ? "Active" : "Starts with PostgreSQL"} good={runtime.passwordAuthActive} /><StatusRow label="Password reset email" value={runtime.passwordResetConfigured ? "Configured" : "Email sender required"} good={runtime.passwordResetConfigured} /><StatusRow label="Team administration" value={currentRole === "admin" ? "Admin only" : "Restricted"} good={currentRole === "admin"} /></div></article>
