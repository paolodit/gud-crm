"use client";
import { SoloModeSetting } from "./solo-mode-setting";
  ...
  return (
    <WorkspaceFrame title="Settings" subtitle="Workspace shape, data readiness and operational guardrails">
      ...
      <SettingsSections>
        ...
        <FreeMaxSettingsCard data-settings-tab="ai" status={runtime.freeMaxStatus} canManage={currentRole === "admin"} />
...
function settingsStageGuidance(name: string) {
  return ({
    ...
    "Gone Cold": "Paused, not lost. Resume when there is a credible reason to reconnect.", "Nurture": "Real relationship signal, inactive timing, and a recorded re-entry trigger.",
