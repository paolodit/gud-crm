...
Thoughts is separate from the shared Ideas/research workflow, Pipeline and Live projects. The `/thoughts` board supports free-position notes, unnamed lane guides, comfortable/compact views, optional titles/categories, six colours, plain text/bullets, and draggable checklists. View preferences contain no note content. New notes seek free space; dragging saves their coordinates. Archives are reversible.
